...
const FEATURES = [
  ...
  { icon:'🎵', title:'Music Discovery',   to:'/search',   cta:'Browse music',  desc:"Search the KalzTunz music library. Browse by genre or mood, explore any artist's full profile, and play a short chord preview directly in the browser — no account needed." },
    ...
    <div className="page-wrap" style={{ paddingTop: 0 }}>
      ...
      <div className="hero">
        <div className="hero-badge fade-up">
          ...
          AI Music Platform · Chord Extraction & Generation
        </div>
        ...
        <p className="hero-sub fade-up delay-2">
          ...
          in seconds. Generate new progressions, browse the music library, and export PDF sheet music.
        ...
        <div className="fade-up delay-4" style={{ marginTop:'1.75rem',display:'flex',justifyContent:'center',alignItems:'center',gap:'1.5rem',flexWrap:'wrap' }}>
          {['No upload limit','Instant chord previews','PDF export','Free account in 10 seconds'].map(t => (
